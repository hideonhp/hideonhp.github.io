...
## Các thiết bị nào được sử dụng cổng Apple Lightning?
...
IPhone 5, 5C, 5S, 6/6 Plus, 6S/6S Plus, SE, 7/7 Plus, 8/8 Plus, X, XS/XS Max, XR, 11/11 Pro/11 Pro Max, 12/12 Pro/ 12 Pro Max, SE 2020.
`Đối với dòng sản phẩm Ipad`
IPad (thế hệ thứ 4, 5, 6, 7, 8), Mini (thế hệ thứ 1, 2, 3, 4, 5), Air ( thế hệ thứ 1, 2, 3, 4), Tất cả dòng Pro (Trừ bản thứ 3 trở xuống).
`Đối với dòng sản phẩm Ipod`
Ipod Nano 7, Touch (thế hệ thứ 5, 6, 7)
```
